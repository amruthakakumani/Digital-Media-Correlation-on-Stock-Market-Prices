...
Separate the Reddit data by company mention and compile the posts’ metrics (sentiment, comments, upvotes, etc). Separate S&P 500 company stock data by company.
Conduct correlation analysis using Reddit sentiment scores and post metrics with individual company stock price changes and trading volume.
